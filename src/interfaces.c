...
// cudaSetupArgument calls is a device memory pointer. %rw is the
// read-write flag. The caller may simply specify rw=0 to use the
...
//
GMM_EXPORT
cudaError_t cudaReference(int which_arg, int rw)
{
	int i;
